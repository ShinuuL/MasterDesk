...
| [ADR-006](./ADR-006-mastersys-integration.md) | Integração Mastersys | Bloqueado — precisa de doc real da API |
...
3. ADR-005/006/007 permanecem bloqueados até suas respectivas fases.
